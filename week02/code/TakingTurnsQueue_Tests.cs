...
public class TakingTurnsQueueTests
{
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: people with infinite turns are not being readded to the queue
    ...
    // Defect(s) Found: people with negative infinite turns are removed from the queue and not readded
